<xsl:stylesheet exclude-result-prefixes="d"
    ...
    <xsl:output method="html" encoding="utf-8" cdata-section-elements=""/>
    ...
    <xsl:param name="webhelp.base.dir">out</xsl:param>
 ...
 <xsl:variable name="addns">
  ...
  <xsl:apply-templates select="exsl:node-set($addns)"/>
    ...
    <xsl:template name="index.html">
        ...
        <!-- OXYGEN PATCH START EXM-20289 - no create index.html file in base.dir 
             that does redirecting to main output file -->
