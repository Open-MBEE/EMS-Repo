...
mvn integration-test -U -f $pom -Pmbee-dev -Pamp-to-war -Dmaven.test.skip=true -Dmaven.tomcat.port=9093 2>runserver.err 2>&1 | tee runserver.log | tee runserver.out
