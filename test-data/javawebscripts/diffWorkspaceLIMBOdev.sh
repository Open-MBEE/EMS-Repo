...
#export CURL_SECURITY=" -k -3"
       ...
       export BASE_URL="http://localhost:9093/alfresco/service/workspaces/master/"
#else
...
# post snapshot
echo 'testSNAP1'
echo  curl -w "%{http_code}" -u admin:admin -X POST -H "Content-Type:text/html" --data @JsonData/snapshot.html http://localhost:9093/alfresco/service/ui/views/301/snapshot
