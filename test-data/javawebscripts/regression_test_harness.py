...
True,
common_filters + ['"owner"', '"qualifiedId"', '"qualifiedName"'],
["test", "workspaces", "ws", "develop", "develop2", "parsek"]
],
...
create_curl_cmd(type="GET", data="elements/123456?recurse=true", base_url=BASE_URL_WS,
                branch="master/"),
True,
common_filters + ['"MMS_', 'MMS_', '"owner"', '"qualifiedId"', '"qualifiedName"'],
...
create_curl_cmd(type="DELETE", data="elements/6666", base_url=BASE_URL_WS,
                branch="master/"),
True,
common_filters + ['"timestamp"', '"MMS_', '"id"', '"qualifiedId"', '"version"', '"modified"', '"sequence"', '"owner"', '"qualifiedId"', '"qualifiedName"'],
["test", "workspaces", "develop", "develop2"]
],
...
True,
common_filters + ['"id"', '"qualifiedId"', '"creator"', '"modifier"', '"owner"', '"qualifiedName"'],
["test", "workspaces", "develop"],
None,
None,
# do20 
...
create_curl_cmd(type="GET", base_url=SERVICE_URL,
                branch="diff/$gv1/$gv2/latest/latest?background&changesForMerge"),
True,
common_filters + ['"id"', '"qualifiedId"', '"diffTime"', '"creator"', '"modifier"', '"owner"', '"qualifiedName"'],
["test", "workspaces", "develop"],
None,
None,
None,
...
True,
common_filters + ['"id"', '"qualifiedId"', '"timestamp"', '"creator"', '"modifier"', '"owner"', '"qualifiedName"'],
["test", "workspaces", "develop"]
],
...
True,
common_filters + ['"id"', '"qualifiedId"', '"timestamp"', '"sequence"', '"creator"', '"modifier"', '"owner"', '"qualifiedName"'],
["test", "workspaces", "develop"],
],
...
True,
common_filters + ['MMS_', '"owner"', '"qualifiedId"', '"qualifiedName"'],
...
True,
common_filters + ['MMS_', '"evaluationResult"', '"owner"', '"qualifiedId"', '"qualifiedName"'],
["test", "workspaces", "develop", "develop2", "parsek"]
],
...
"Checks the MMS version when requesting an element, request was made  but the REST call was missing the parameter '?mmsVersion=2.3'.",
create_curl_cmd(type="GET", data="elements/303", base_url=BASE_URL_WS,
        branch="master/"),
True,
common_filters + ['"timestamp"'],
...
create_curl_cmd(type="GET", data="sites/europa/elements/MMS_1450390431247_8a4b76d2-394c-4569-9abe-5c51dc4b0711", base_url=BASE_URL_WS,
                branch="master/"),
True,
common_filters + ['"timestamp"', '"owner"', '"qualifiedId"', '"qualifiedName"'],
["test", "workspaces", "develop", "develop2"]
],
[
10130.2,
...
create_curl_cmd(type="POST", data="TestCase10131_postViewV.json", base_url=BASE_URL_WS,
                post_type="elements", branch="master/"),
True,
common_filters + ['MMS_', '"timestamp"', '"owner"', '"qualifiedId"', '"qualifiedName"'],
["test", "workspaces", "develop", "develop2"]
],
[
10132,
