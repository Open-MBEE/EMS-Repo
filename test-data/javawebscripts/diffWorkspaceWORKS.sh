...
#echo curl $CURL_FLAGS $CURL_GET_FLAGS $BASE_URL"sites/europaTest/projects/PROJECT-123456\""
#curl $CURL_FLAGS $CURL_GET_FLAGS $BASE_URL"sites/europaTest/projects/PROJECT-123456"
echo
echo
