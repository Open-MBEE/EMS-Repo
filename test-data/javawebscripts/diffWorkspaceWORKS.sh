...
echo curl $CURL_FLAGS $CURL_POST_FLAGS '{"name":"CY Test"}' $BASE_URL"sites/europaTest/projects/123456?createSite=true" 
curl $CURL_FLAGS $CURL_POST_FLAGS '{"name":"CY Test"}' $BASE_URL"sites/europaTest/projects/123456?createSite=true" > outputWorkspaces/post1.json
