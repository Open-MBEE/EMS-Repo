...
common_filters = ['"nodeRefId"', '"versionedRefId"', '"created"','"read"',
                  '"lastModified"','"modified"','"siteCharacterizationId"',
                  'time_total']
holding_bin_filters = [ 'YY_', 'MM_', 'DD_', 'HH_', '"owner"', '"qualifiedId"', '"qualifiedName"' ]
cmd_git_branch = None
