{ "elementHierarchy" : { "_12345_0_be00301_1147682946132_981479_8" : [ "_12345_0_be00301_1147682950728_698804_11",
  ...
  "elements" : { [{ "documentation" : "A FlowPort is an interaction point through which input and/or output of items such as data, material, or energy may flow. This enables the owning block to declare which items it may exchange with its environment and the interaction points through which the exchange is made. We distinguish between atomic flow port and a nonatomic flow port. Atomic flow ports relay items that are classified by a single Block, ValueType, DataType, or Signal classifier. A nonatomic flow port relays items of several types as specified by a FlowSpecification. Flow ports and associated flow specifications define “what can flow” between the block and its environment, whereas item flows specify “what does flow” in a specific usage context. Flow ports relay items to their owning block or to a connector that connects them with their owner’s internal parts (internal connector).",
          "isView" : false,
          "name" : "FlowPort",
      ...
      { "documentation" : "This is a derived attribute (derived from the flow port’s type). For a flow port typed by a flow specification the value of this attribute is False, otherwise the value is True.",
          "isDerived" : true,
          "isSlot" : false,
          "isView" : false,
          "name" : "isAtomic",
  ...
  "roots" : [ "_12345_5EAPbeta_be00301_1148301962580_941673_3150",
    ...
    "relationships" : {
        "propertyTypes" : { "_12345_0_be00301_1147682950728_698804_11" : "_12345_5EAPbeta_be00301_1148651295316_167207_450"},
    }
}