...
# branch A
curl 'http://127.0.0.1:9000/alfresco/s/workspaces/A?sourceWorkspace=master&copyTime=null' -u admin:admin -X POST

# branch B
curl 'http://127.0.0.1:9000/alfresco/s/workspaces/B?sourceWorkspace=A&copyTime=null' -u admin:admin -X POST

# branch C
curl 'http://127.0.0.1:9000/alfresco/s/workspaces/C?sourceWorkspace=B&copyTime=null' -u admin:admin -X POST

# tag A1
curl 'http://127.0.0.1:8080/alfresco/s/workspaces/A/configurations' -u admin:admin -H 'Content-Type:application/json' -d '{"configurations":[{"name":"A1","description":""}]}'
...
# create A2
curl 'http://127.0.0.1:8080/alfresco/s/workspaces/A/elements' -u admin:admin -H 'Content-Type:application/json' -d '{"elements":[{"sysmlid":"_24_0_5_1_8660276_1414446925841_771668_16706", "name": "A2"}]}'

# tag A2
curl 'http://127.0.0.1:8080/alfresco/s/workspaces/A/configurations' -u admin:admin -H 'Content-Type:application/json' -d '{"configurations":[{"name":"A2","description":""}]}'
